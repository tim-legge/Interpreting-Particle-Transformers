...
if not os.path.exists('/path/to/storage/tl_counter.txt'):
    counter = 0
    with open('/path/to/storage/tl_counter.txt', 'w') as f:
        f.write(str(counter))
else:
    print('Counter file exists, resuming from last batch')
    with open('/path/to/storage/tl_counter.txt', 'r') as f:
...
if not os.path.exists('/path/to/storage/tl_dist_counter.txt'):
    tl_dist_counter = 0
    with open('/path/to/storage/tl_dist_counter.txt', 'w') as f:
        f.write(str(tl_dist_counter))
else:
    print('Distribution counter file exists, resuming from last batch')
    with open('/path/to/storage/tl_dist_counter.txt', 'r') as f:
...
if tl_dist_counter >= 51:
    ...
    while tl_dist_counter < 51:
        ...
        attention = np.load(f'/path/to/storage/batched_attns/tl_run4_attention_batch_{tl_dist_counter}.npy', allow_pickle=True)
        ...
        np.save(f'/path/to/storage/batched_hists/tl_run4_hist_distribution_batch_{tl_dist_counter}.npy', tl_probabilities)
