...
for k, v in jc_full_top_hadronic.items():
    np.save(f'./jc_full_top_hadronic_{k}', v)
for k, v in jc_full_top_leptonic.items():
    np.save(f'./jc_full_top_leptonic_{k}', v)
for k, v in jc_kin_top_hadronic.items():
    np.save(f'./jc_kin_top_hadronic_{k}', v)
for k, v in jc_kin_top_leptonic.items():
    np.save(f'./jc_kin_top_leptonic_{k}', v)
...
print('Saved full JC dataset arrays for hadronic and leptonic top decay!')