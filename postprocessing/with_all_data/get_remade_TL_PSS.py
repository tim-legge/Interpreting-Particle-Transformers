# This script generated the final Attn. Score/Inter. Score plot for the Top Landscape dataset
...
tl_hooks = ParT_Hook(model=tl_model)


howmanyjets = 500

qgtrained_modelpath = './model/on-qg-run2_best_epoch_state.pt'
