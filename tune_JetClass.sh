...
dataopts="--num-workers 2 --fetch-step 0.005"
...
$CMD \
    ...
    --model-prefix training/JetClass/${SAMPLE_TYPE}/${FEATURE_TYPE}/${model}/{auto}${suffix}/net --load-model-weights ./models/ParT_full.pt \
    $dataopts $batchopts \
